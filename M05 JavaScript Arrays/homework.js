...
function multiplicarArgumentos() {
   ...
   if (arguments.length === 0) {
      ...
      return arguments[0]; // Si se pasa un argumento, simplemente retórnalo.
    } else {
      let producto = 1;
...
function mesesDelAño(array) {
  ...
  if (mesesEncontrados.length === 3) {
    return mesesEncontrados; // Se encontraron los tres meses buscados.
  } else {
    return "No se encontraron los meses pedidos"; // Alguno de los meses no está.
  }
}
